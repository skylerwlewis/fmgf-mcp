...
An [MCP (Model Context Protocol)](https://modelcontextprotocol.io/) server that lets AI assistants search [findmeglutenfree.com](https://www.findmeglutenfree.com/) for gluten-free restaurants and businesses near any address.
...
| `address` | string | **Yes** | — | **Near (Address, City, State or Postal Code)** — e.g. `"1600 Pennsylvania Ave NW, Washington, DC 20500"` or `"Chicago, IL"` |
